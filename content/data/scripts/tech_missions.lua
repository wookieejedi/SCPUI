...
function TechMissionsController:selectCampaign(campaign)
...
function TechMissionsController:create_pilot_li(campaign)
...
function TechMissionsController:init_campaign_list()
