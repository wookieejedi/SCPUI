...
---
--- @return string uuid a properly formatted uuid string
--- @param hwaddr? string containing a unique hex value (e.g.: `00:0c:29:69:41:c6`), to be used to compensate for the lesser `math_random()` function. Use a mac address for solid results. If omitted, a fully randomized uuid will be generated, but then you must ensure that the random seed is set properly!
--- @usage
...
--- @param seed number the random seed to set (integer from 0 - 2^32, negative values will be made positive)
--- @return number seed the (potentially modified) seed used
--- @usage
...
--- **Important:** the random seed is a global piece of data. Hence setting it is
--- an application level responsibility, libraries should never set it!
--- @return number seed the seed used
--- @usage
--- local socket = require("socket")  -- gettime() has higher precision than os.time()
